import {interpolation} from './Utility'

export function animateElement(element, startCond, endCond, progress) {
  // 변화될 상태 계산
  var states = {}
  for (option in startCond) {
    var state = interpolation(progress, 0, 1, startCond[option], endCond[option])
