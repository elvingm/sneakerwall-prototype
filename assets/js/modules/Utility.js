...
export function sumCoord(coord1, coord2) {
...
export function subCoord(coord1, coord2) {
...
export function getDist(coord1, coord2) {
...
export function interpolation(p, w1, w2, v1, v2) {
  if (w1 > w2) {
    if (p >= w1) {
      return v1;
    } else if (p <= w2) {
...
export function loadJsCssFile(fileName, fileType, callback){
